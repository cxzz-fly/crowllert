...
var request = __importStar(require("superagent")); //引用声明
var handAnalyzer_1 = __importDefault(require("./handAnalyzer"));
var Crowller = /** @class */ (function () {
    ...
    Crowller.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var html, analyzerCont;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRawHtml()];
                    case 1:
                        html = _a.sent();
                        analyzerCont = analyzer.analyze(html, this.filePath);
...
var analyzer = handAnalyzer_1.default.getInstance();
